...
export class AddCompanyComponent implements OnInit {
  ...
  submit() {
    let companyFullNameUa =
      this.editCompany.controls['companyFullNameUa'].value;
    let companyNameUa = this.editCompany.controls['companyNameUa'].value;
    let companyFullNameEng =
      this.editCompany.controls['companyFullNameEng'].value;
    ...
    let registrationCertificate =
      this.editCompany.controls['registrationCertificate'].value;
    let ipn = this.editCompany.controls['ipn'].value;
    let accountingTaxInfo =
      this.editCompany.controls['accountingTaxInfo'].value;
